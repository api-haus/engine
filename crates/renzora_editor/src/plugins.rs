...
pub(crate) fn add_editor_plugins(app: &mut App) {
    ...
    app.add_plugins(renzora_atmospherics_editor::AtmosphericsEditorPlugin::default());
    ...
    app.add_plugins(renzora_graybox_terrain_editor::GrayboxTerrainEditorPlugin::default());
